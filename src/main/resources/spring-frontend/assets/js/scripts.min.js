                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'author':
                                ...
                                break;
                            case'authorPage':
                                getData('/books/authorPage/' + $this.data('refreshid'), {
                            ...
                            if (!error) {
                                postData('/login', $this.data('send'), function (result) {
                                    if (result != null && result.result) {
                                        ...
                                        /*console.log('tesss' + result.error);
                                        if (result) {
                                            $thisStep.addClass('Login-step_hide');
                ...
                init: function () {
                    ...
                    $btnSend.on('click', function (e) {
                        ...
                        if ($this.data('sendstatus') === 'ARCHIVED' && $this.data('check')) {
                            ...
                            Login().postData('/books/changeBookStatus/' + status.toLowerCase() +'/' + $this.data('bookid'), {
                                booksIds: $this.data('bookid'),
                                status: status
                            }, function (result) {
                                if (result.result) {
                    ...
                    $ProductAssesment.find('.Rating input').on('change', function (e) {
                        ...
                        Login().postData('/books/rateBook/' + $this.closest('.Rating').data('bookid') +'/'+ (check ? $this.val() : 0), {
